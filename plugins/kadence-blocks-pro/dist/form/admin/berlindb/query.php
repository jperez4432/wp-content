...
class Query extends Base {
	...
	private function set_query_var_defaults() {
		...
		$this->query_var_defaults = array(
			...
			'date_query'        => null, // See Date
			'compare_query'     => null, // See Compare
			'no_found_rows'     => true,
	...
	/**
	 * Pass-through method to return a new Date object.
	 *
	 * @since 1.0.0
	 *
	 * @param array  $args   See Date
	...
	private function get_date_query( $args = array(), $column = 'date_created' ) {
		...
		$date_query = new Date( $args, $column );
		$table      = $this->get_table_name();
	 ...
	 */
	public function override_get_objects( $item_ids = array() ) {
		$this->set_items( $item_ids );
	...
	private function parse_where() {
		...
		$compare = $this->query_vars['compare_query'];
